...
def linha_vermelho_escuro():
    st.markdown(
        """
        <hr style="border: 2px solid #8B0000;">
        """,
        unsafe_allow_html=True,
    )
...
def draw_blue_line():
    """Draws a horizontal blue line."""
    st.markdown("<hr style='border: 2px solid #1E7FE4;'>", unsafe_allow_html=True)
...
def home_page():
    ...
    if st.button("Enviar Embarque", key="enviar_embarque"):
        pass
